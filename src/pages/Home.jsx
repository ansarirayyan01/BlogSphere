...
function Home() {
  ...
  useEffect(() => {
    document.title = "BlogSphere - Home";
              ...
              <div className="lg:w-1/2">
                <div className="relative">
                  ...
                  <div className="relative overflow-hidden bg-white p-6 rounded-lg shadow-xl">
                    ...
                    <h2 className="text-2xl font-bold text-gray-800 mb-4">Welcome to BlogSphere</h2>
      ...
      <div className="bg-gradient-to-br from-primary-700 via-primary-800 to-primary-900 text-white py-16">
        <Container>
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-4xl sm:text-5xl font-extrabold mb-6">BlogSphere</h1>
