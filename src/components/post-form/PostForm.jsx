    ...
    try {
      ...
      if (post) {
        ...
        if (data.image && data.image[0]) {
          ...
          // Use a fallback Unsplash image if no image is provided
          const fallbackIndex = getFallbackImageIndex();
          fileId = FALLBACK_IMAGES[fallbackIndex];
          console.log("Using fallback image:", fileId);
        }
        
        // Create post with or without uploaded image
        const postData = {
          title: data.title,
          slug: data.slug,
